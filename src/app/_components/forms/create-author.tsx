...
import { stringRegex, yearRegex } from "@/lib/utils";
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col md:w-1/2">
                  ...
                  <FormDescription>The author's first name.</FormDescription>
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col md:w-1/2">
                  ...
                  <FormDescription>The author's last name.</FormDescription>
                </FormItem>
              )}
            />
          </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col md:w-1/3">
                  ...
                  <FormDescription>The author's nationality.</FormDescription>
                </FormItem>
              )}
            />
          </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  ...
                  <FormDescription>The author's biography.</FormDescription>
                </FormItem>
              )}
            />
          </div>
