      ...
      >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-2/3">
                <FormLabel className="font-bold">Book's Title</FormLabel>
                <FormMessage className="space-y-0 text-red-600" />
                <FormControl>
                  <Input placeholder="Title" className="rounded" {...field} />
                </FormControl>
                <FormDescription>The book's title.</FormDescription>
              </FormItem>
            )}
          />
          {/* Book Rating Field */}
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/3">
                <FormLabel className="font-bold">Book's Rating</FormLabel>
                <FormMessage className="space-y-0 text-red-600" />
                <Select
                  onValueChange={(value) => {
        ...
        <div className="flex w-full flex-col gap-6 md:flex-row md:gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/3">
                ...
                <FormDescription>Select the book's authors.</FormDescription>
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/3">
                <FormLabel className="font-bold">Book's Source Link</FormLabel>
                <FormMessage className="space-y-0 text-red-600" />
                <FormControl>
                  <Input
                ...
                <FormDescription>The book's source link.</FormDescription>
              </FormItem>
            )}
          />
          {/* Book Genres Field */}
        ...
        <div className="flex w-full flex-col gap-6 md:flex-row md:gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/3">
                ...
                <FormDescription>The book's publication year.</FormDescription>
              </FormItem>
            )}
          />
          {/* Book ISBN Field */}
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/3">
                <FormLabel className="font-bold">Book's ISBN</FormLabel>
                <FormMessage className="space-y-0 text-red-600" />
                <FormControl>
                  <Input placeholder="ISBN" className="rounded" {...field} />
                </FormControl>
                <FormDescription>The book's ISBN.</FormDescription>
              </FormItem>
            )}
          />
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/3">
                ...
                >
                  ...
                  <SelectContent>
                    {allPublishers.data?.map((publisher) => (
                      <SelectItem
                        key={publisher.id}
                ...
                <FormDescription>The book's publisher.</FormDescription>
              </FormItem>
            )}
          />
        </div>
        <div className="flex w-full flex-col gap-6 md:flex-row md:gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/2">
                <FormLabel className="font-bold">Book's Summary</FormLabel>
                <FormMessage className="space-y-0 text-red-600" />
                <FormControl>
                  <Textarea
                    placeholder="Summary"
                ...
                <FormDescription>The book's summary.</FormDescription>
              </FormItem>
            )}
          />
          {/* Book Citation Field */}
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex w-full flex-col md:w-1/2">
                <FormLabel className="font-bold">Book's Citation</FormLabel>
                <FormMessage className="space-y-0 text-red-600" />
                <FormControl>
                  <Textarea
                ...
                <FormDescription>The book's citation.</FormDescription>
              </FormItem>
            )}
          />
        </div>
